...
// Aynı JSON, kavisapp.com/gizlilik statik sayfasını üretmek için web/build.mjs
// tarafından da okunuyor (bkz. web/README.md). Metni güncellerken SADECE bu
// JSON'ı değiştirin, ekrana veya web sayfasına elle dokunmayın.
const { lastUpdated, privacy } = legalContent;

export default function GizlilikPolitikasiScreen() {
  return (
    <>
      <Stack.Screen options={{ title: privacy.title, headerShown: true }} />
      <ScreenContainer>
